...
export type schema_migrationsWhereInput = {
  ...
  id?: Prisma.IntFilter<"schema_migrations"> | number
  filename?: Prisma.StringFilter<"schema_migrations"> | string
  applied_at?: Prisma.DateTimeNullableFilter<"schema_migrations"> | Date | string | null
}
...
export type schema_migrationsOrderByWithAggregationInput = {
  ...
  _avg?: Prisma.schema_migrationsAvgOrderByAggregateInput
  _max?: Prisma.schema_migrationsMaxOrderByAggregateInput
  _min?: Prisma.schema_migrationsMinOrderByAggregateInput
  _sum?: Prisma.schema_migrationsSumOrderByAggregateInput
}
...
export type schema_migrationsScalarWhereWithAggregatesInput = {
  ...
  id?: Prisma.IntWithAggregatesFilter<"schema_migrations"> | number
  filename?: Prisma.StringWithAggregatesFilter<"schema_migrations"> | string
  applied_at?: Prisma.DateTimeNullableWithAggregatesFilter<"schema_migrations"> | Date | string | null
}
...
export type schema_migrationsOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "filename" | "applied_at", ExtArgs["result"]["schema_migrations"]>
...
export interface schema_migrationsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `id`
   * const schema_migrationsWithIdOnly = await prisma.schema_migrations.findMany({ select: { id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Schema_migrations and only return the `id`
   * const schema_migrationsWithIdOnly = await prisma.schema_migrations.createManyAndReturn({
   *   select: { id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Schema_migrations and only return the `id`
   * const schema_migrationsWithIdOnly = await prisma.schema_migrations.updateManyAndReturn({
   *   select: { id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface schema_migrationsFieldRefs {
  readonly id: Prisma.FieldRef<"schema_migrations", 'Int'>
  readonly filename: Prisma.FieldRef<"schema_migrations", 'String'>
