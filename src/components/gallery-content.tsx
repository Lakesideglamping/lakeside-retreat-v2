...
const galleryItems = [
  ...
  { src: "/images/lakesidecottageinterior.jpg", alt: "Lakeside Cottage sitting room", title: "Lakeside Cottage", categories: ["cottage"] as Category[] },
  ...
  { src: "/images/IMG_1266-1920x1080.jpg", alt: "Both domes in winter vineyard with snow-capped mountains", title: "Winter at Lakeside", categories: ["domes"] as Category[] },
  ...
  { src: "/images/DroneViewRose.jpg", alt: "Dome and vineyard aerial views", title: "Dome Rose' Aerial View", categories: ["domes"] as Category[] },
        ...
        {filtered.map((item) => (
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6 text-white translate-y-full group-hover:translate-y-0 transition-transform duration-300">
              ...
              {/* Show the first category as the hover label; items can belong
                  to multiple categories for filtering purposes. */}
              <div className="text-sm text-burgundy">{categoryLabels[item.categories[0]]}</div>
            </div>
          </button>
        ))}
      </div>
