        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { href: "/dome-rose", image: "/images/dome-rose-spa1.jpeg", title: "Dome Rosé", badge: "Adults Only", price: "From $510/night", note: "Private spa, mountain views, full kitchen" },
              { href: "/lakeside-cottage", image: "/images/lakeside-cottage-exterior.jpeg", title: "Lakeside Cottage", badge: "Pet Friendly", price: "From $295/night", note: "2 bedrooms, direct lake access" },
            ].map((acc) => (
              <Link
                key={acc.href}
                href={acc.href}
