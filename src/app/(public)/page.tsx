        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {[
              ...
              { author: "Ryan", accommodation: "Lakeside Cottage", date: "February 2026", text: "Such a lovely place. The lake views from the deck, the hot tub under the stars, and the attentive hosts made our family holiday unforgettable." },
